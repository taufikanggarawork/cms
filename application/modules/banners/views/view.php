<form method="post" action="<?php echo site_url('banners/delete'); ?>">
    <div class="content-wrapper">
        <section class="content-header">
            <h1 class="pull-left"><?php echo $subtitle; ?></h1>
            <div class="pull-right">
                <a href="<?php echo site_url('banners/add'); ?>" class="btn btn-success btn-sm" data-placement="left" data-toggle="tooltip" data-original-title="Tambah"><i class="fa fa-plus"></i></a>
                                ...
                                <?php $no = 1; foreach($banners as $row): ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="<?php echo site_url('banners/edit/'.$row->id) ?>" class="btn btn-info btn-sm" data-placement="top" data-toggle="tooltip" data-original-title="Ubah"><i class="glyphicon glyphicon-edit"></i></a>
                                        </td>
                                    </tr>
                                    <?php $no++; endforeach; ?>
                                </tbody>
