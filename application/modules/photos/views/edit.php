        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    <form class="form-horizontal" method="post" id="" action="<?php echo site_url('photos/update'); ?>" enctype="multipart/form-data">
                        <div class="box-body">
                            <input type="hidden" name="id" value="<?php echo $edit->id; ?>">
                            <div class="form-group">
                                <label class="control-label col-sm-2">Judul &nbsp<span class="required">*</span></label>
                                <div class="col-md-8">
                                    <input class="form-control" name="judul" id="judul" value="<?php echo $edit->photos_title; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input class="form-control" name="deskripsi" id="deskripsi" value="<?php echo $edit->photos_desc; ?>">
                                </div>
                            </div>
                            <div class="form-group">
