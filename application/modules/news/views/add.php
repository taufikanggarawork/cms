        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    <form class="form-horizontal" method="post" id="" action="<?php echo site_url('news/save'); ?>" enctype="multipart/form-data">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <textarea class="ckeditor" name="isi_berita" rows="150"><?php echo set_value('isi_berita'); ?></textarea>
